...
<div class="mx-auto h-full flex justify-center items-center">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                <label for="email" class="uppercase text-blue-500 text-xs text-bold absolute pl-3 pt-2">{{ __('E-Mail') }}</label>

                <div class="">
                    <input id="email" type="email" placeholder="Your@email.com" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
            ...
            <div class="relative pt-3">
                ...
                <div class="col-md-6">
                    <input id="password" type="password" placeholder="Password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700 @error('password') is-invalid @enderror" name="password" autocomplete="current-password">
