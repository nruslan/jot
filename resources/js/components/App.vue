        ...
        <div class="flex">
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600">
                        ...
                        <div class="tracking-wide pl-3 text-sm">Add New</div>
                    </router-link>
                    ...
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600">
                        ...
                        <div class="tracking-wide pl-3 text-sm">Contacts</div>
                    </router-link>
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600">
                        ...
                        <div class="tracking-wide pl-3 text-sm">Birthdays</div>
                    </router-link>
                    ...
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600">
                        ...
                        <div class="tracking-wide pl-3 text-sm">Log Out</div>
                    </router-link>
                </nav>
            </div>
            <div class="flex flex-col flex-1 h-screen overflow-y-hidden">
                <div class="h-16 px-6 border-b border-gray-400 flex items-center justify-between">
                    <div>Contacts</div>
                    <div class="rounded-full border border-gray-400 text-white bg-blue-400 w-10 h-10 flex justify-center items-center">RN</div>
                </div>
