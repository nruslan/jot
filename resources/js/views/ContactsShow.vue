    ...
    <div>
        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div class="relative">
                    <router-link :to="'/contacts/' + contact.contact_id + '/edit'" class="px-4 py-2 rounded text-sm text-green-500 border border-green-500 text-sm font-bold">Edit</router-link>
                    ...
                    <div v-if="modal" class="absolute bg-blue-900 text-white rounded-lg z-20 p-8 w-64 right-0 mt-2 mr-6">
                        ...
                        <div class="flex items-center mt-6 justify-end">
                            <button class="px-4 py-2 text-white" @click="modal = ! modal">Cancel</button>
